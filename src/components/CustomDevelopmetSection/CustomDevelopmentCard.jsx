...
const CustomDevelopmentCard = () => {
  return (
    // border-transparent
    <div className="group max-w-90 p-5 border-t-3 border-l-2 border-r-2  border-transparent hover:border-t-3 hover:border-l-2 hover:border-r-2 hover:rounded-tl-xl hover:rounded-tr-[100px] hover:rounded-bl-lg hover:rounded-br-lg hover:border-[#F9A41B] text-white  ">
      {/* Title row */}
